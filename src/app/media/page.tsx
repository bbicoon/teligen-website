          ...
          <div className="space-y-8">
            <Card className="hover:shadow-lg transition-shadow duration-300">
              <CardHeader>
                ...
                <CardTitle className="text-2xl">
                  다양한 형태의 무인매장키오스크 만나요
                </CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base mb-4">
                  카페, 식당, 문구점 등 다양한 업종에서 무인 운영이 확산되고
                  있습니다. 키위오더는 소상공인을 위한 IOT 판매 및 렌탈 솔루션을
                  제공하며, PSD215, i-10P, i-20R 등 다양한 키오스크 모델을
                  만나볼 수 있습니다.
                </CardDescription>
                <Button
                  asChild
            ...
            <Card className="hover:shadow-lg transition-shadow duration-300">
              <CardHeader>
                ...
                <CardTitle className="text-2xl">
                  문구점키오스크 저비용 창업과 무인 운영도 가능합니다
                </CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base mb-4">
                  문구점은 학용품부터 간식, 장난감, 아이돌 굿즈까지 다양한
                  상품을 판매하는 공간으로 확장되고 있습니다. 문구점키오스크를
                  활용하면 인건비 절약과 무인 운영이 가능하여 주부, 직장인 등이
                  투잡으로 창업할 수 있습니다. 카드 및 현금 결제 모두 지원하는
                  제품으로 저렴한 렌탈 비용으로 부담 없이 시작할 수 있습니다.
                </CardDescription>
                <Button
                  asChild
                  variant="link"
