    ...
    <div>
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-slate-600 max-w-3xl mx-auto">
          언제 어디서든 모바일 앱으로 매장 장비를 원격으로 제어하고 상태를
          확인할 수 있습니다.
        </p>
      </div>
      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <Card className="hover:shadow-lg transition-shadow duration-300">
            ...
            <CardContent>
              <CardDescription className="text-center">
                스마트폰으로 키오스크를 원격으로 연결해 전원을 끄거나 재부팅할
                수 있습니다
              </CardDescription>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow duration-300">
            ...
            <CardContent>
              <CardDescription className="text-center">
                키오스크의 상태를 확인할 수 있는 기능으로, 간단한 모니터링에
                적합합니다
              </CardDescription>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow duration-300">
            ...
            <CardContent>
              <CardDescription className="text-center">
                원격으로 조작이 필요할 때 사용하여 즉각적인 수정과 보완을
                가능하게 합니다
              </CardDescription>
            </CardContent>
          </Card>
      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <Card className="hover:shadow-lg transition-shadow duration-300">
            ...
            <CardContent>
              <CardDescription>
                실시간 알림 기능을 통해 키오스크의 장애를 즉각 파악하고 대응할
                수 있습니다.
              </CardDescription>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow duration-300">
            ...
            <CardContent>
              <CardDescription>
                다른 사용자와 단말기를 공유하여 협력적인 매장 관리를 도울 수
                있습니다.
              </CardDescription>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow duration-300">
            ...
            <CardContent>
              <CardDescription>
                마이크 기능을 통해 고객과 직접 소통할 수 있어 고객 만족도를
                높입니다.
              </CardDescription>
            </CardContent>
          </Card>
