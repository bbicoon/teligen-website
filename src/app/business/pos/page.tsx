    ...
    <div>
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-slate-600 max-w-3xl mx-auto">
          재고 관리부터 고객 관리까지, 유통업에 특화된 전문 POS 프로그램으로
          매장을 스마트하게 관리하세요.
        </p>
      </div>
      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <Card className="hover:shadow-lg transition-shadow duration-300">
            ...
            <CardContent>
              <CardDescription>
                현금, 카드, 모바일 결제, 포인트 적립 등 다양한 결제 수단을
                지원합니다.
              </CardDescription>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow duration-300">
            ...
            <CardContent>
              <CardDescription>
                매장 규모와 업종에 맞는 맞춤형 설정으로 최적의 운영 환경을
                제공합니다.
              </CardDescription>
            </CardContent>
          </Card>
      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            {
              title: "안정성",
              description: "검증된 시스템으로 안정적인 운영 보장",
            },
            {
              title: "확장성",
              description: "매장 규모에 따라 유연하게 확장 가능",
            },
            {
              title: "보안",
              description: "데이터 보안 및 백업 시스템으로 안전한 운영",
            },
            {
              title: "지원",
              description: "전문 기술 지원팀의 24시간 고객 지원",
            },
            {
              title: "업데이트",
              description: "지속적인 기능 개선 및 업데이트 제공",
            },
