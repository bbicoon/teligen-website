    ...
    <div>
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-slate-600 max-w-3xl mx-auto">
          최신 기술이 적용된 스마트 자판기로 24시간 무인 판매 솔루션을 구축할 수
          있습니다.
        </p>
      </div>
          ...
          <Card className="hover:shadow-lg transition-shadow duration-300">
            ...
            <CardContent>
              <CardDescription className="text-center">
                언제든지 고객이 원하는 상품을 구매할 수 있는 24시간 무인 판매
                시스템
              </CardDescription>
            </CardContent>
          </Card>
      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <Card className="hover:shadow-lg transition-shadow duration-300">
            ...
            <CardContent>
              <CardDescription>
                실시간으로 재고 상태, 매출 현황, 기기 상태를 모니터링할 수
                있습니다.
              </CardDescription>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow duration-300">
            ...
            <CardContent>
              <CardDescription>
                GPS를 활용한 위치 기반 서비스로 고객에게 최적의 상품을
                추천합니다.
              </CardDescription>
            </CardContent>
          </Card>
      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            {
              place: "사무실",
              description: "직원들의 편의를 위한 다양한 상품 제공",
            },
            { place: "학교", description: "학생들의 간식 및 문구용품 판매" },
            { place: "병원", description: "환자 및 보호자들을 위한 편의 상품" },
            {
              place: "공항/역",
              description: "이동 중인 고객들을 위한 즉석 상품",
            },
            {
              place: "아파트",
              description: "주민들의 생활용품 구매 편의 제공",
            },
